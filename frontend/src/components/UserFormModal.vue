      ...
      <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form @submit.prevent="$emit('submit', form)">
          ...
          <div class="flex justify-end gap-3 mt-5">
            <button type="button" @click="$emit('close')" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-full text-sm hover:bg-gray-300 transition">
              Cancelar
            </button>
            <button type="submit" class="px-4 py-2 bg-brand-green text-white rounded-full text-sm hover:bg-emerald-700 transition">
              Salvar
            </button>
          </div>
        </form>
