<template>
    <div class="flex h-screen bg-white">
      ...
      <main class="flex-1 bg-white p-6 md:px-16 pt-[40px]">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Dados do Cedente</h1>
        <p class="text-gray-500 mb-6">Informações completas do cedente vinculado à nota fiscal.</p>
